...
function weather_code_to_description {
    ...
    case $1 in
        ...
        21|25|63|64|81|82|92) printf "$(color 55 136 229)🌧️  Rainy";;
...
function show_forcast {
    ...
    URL="https://api.open-meteo.com/v1/forecast?latitude=$LAT&longitude=$LON&hourly=temperature_2m,precipitation_probability,weather_code&daily=sunrise,sunset&timezone=GMT&temperature_unit=fahrenheit&past_days=1&forecast_days=2"
    #echo "URL: $URL" >&2
    DATA=$(curl -s "$URL")
